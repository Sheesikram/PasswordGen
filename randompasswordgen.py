...
#randompasswordgen.py
#This program generates a random password based on the user's input of how many lower case letters, upper case letters, numbers, and punctuation marks they would like in their password. The password is then copied to the clipboard.
